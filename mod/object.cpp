...
void Object::move(double time_iteration){
    ...
    this -> set_position(vec_sum(vec_sum(vecnum_mult(pow(time_iteration, 2)*0.5, this -> get_acceleration()), vecnum_mult(time_iteration, this -> get_velocity())), this -> get_position()));
